...
var domToLatex = function(element){
  if (element.type === 'text') {
    ...
    //   console.log(element.data.$exceptionHandler(exception, cause)At(i));
    //   if(isAllowedChar(element.data.charCodeAt(i))){
    //     console.log(element.data.charCodeAt(i));
    //     text += element.data[i];
    //   }
    // };
    return element.data;
  ...
  if (element.type === 'tag') {
    var tag_name = config2.tags[element.name]
    var text = '';
